...
@ExtendWith(MockitoExtension.class) // Automatically handles mock initialization
class ExchangeRatesServiceImplTest {
    ...
    void shouldConvertCurrency() {
        ...
        // JUnit 5 style: Use compareTo for BigDecimal equality
        assertEquals(0, expectedConversionResult.compareTo(result));
    }

    @Test
    void shouldFailToConvertWhenAmountIsNull() {
        // Updated to JUnit 5 assertThrows
